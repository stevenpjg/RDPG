...
class ModifiedBasicLSTMCell(RNNCell):
  """Basic LSTM recurrent network cell- modified to get access to weights.
  ...
  def _linear(self, args, output_size, bias, bias_start=0.0, scope=None):
    ...
    with tf.variable_scope(scope or "Linear"):      
      ...
      # Store weights and bias for accessing (modified here)
      self.weights = matrix   
      self.bias = bias_term 
